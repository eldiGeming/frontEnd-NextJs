...
const TableBuku = () => {
  ...
  const handleUpdate = (id_buku: string) => {
    console.log(`Update buku dengan id: ${id_buku}`);
  ...
  return (
    <div className="rounded-[10px] bg-white px-7.5 pb-4 pt-7.5 shadow-1 dark:bg-gray-dark dark:shadow-card">
      ...
      <div className="flex flex-col">
        ...
        {/* Data tabel */}
        {bukuData.map((buku: any, index) => (
          <div
            className={`grid grid-cols-6 sm:grid-cols-6 ${index === buku.length - 1 ? "" : "border-b border-stroke dark:border-dark-3"}`}
            key={buku.id_buku}
          >
